...
import cn.kukinghan.neomega.neomgcomm.common.core.jackson.NeomgcommJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final NeomgcommLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new NeomgcommJavaTimeModule());
	}
