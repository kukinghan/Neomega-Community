 ...
 */
@Slf4j
public class NeomgcommSentinelInvocationHandler implements InvocationHandler {
	...
	NeomgcommSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			NeomgcommSentinelInvocationHandler other = (NeomgcommSentinelInvocationHandler) obj;
