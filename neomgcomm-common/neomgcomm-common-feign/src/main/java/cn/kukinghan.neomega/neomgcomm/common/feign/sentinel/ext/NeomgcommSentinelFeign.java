...
package cn.kukinghan.neomega.neomgcomm.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class NeomgcommSentinelFeign {

	private NeomgcommSentinelFeign() {

	}

	public static NeomgcommSentinelFeign.Builder builder() {
		return new NeomgcommSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public NeomgcommSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new NeomgcommSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new NeomgcommSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new NeomgcommSentinelInvocationHandler(target, dispatch);
				}
